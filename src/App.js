...
const App = () => {
  ...
  useEffect(() => {
    axios.get("https://linkedin-followers-tracker.onrender.com/followers").then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.post("https://linkedin-followers-tracker.onrender.com/add", { date, count: followers });
    alert("Data added!");
    setFollowers("");
    setDate("");
  ...
  const handleEditSubmit = async (e) => {
    ...
    await axios.put("https://linkedin-followers-tracker.onrender.com/update", { date: editDate, count: followers });
    alert("Data updated!");
    setFollowers("");
    setEditDate("");
    setEditMode(false);
  ...
  const handleClear = async () => {
    ...
    if (confirmClear) {
      await axios.delete("https://linkedin-followers-tracker.onrender.com/clear");
  ...
  const handleForecast = async (days) => {
    try {
      const response = await axios.get(`https://linkedin-followers-tracker.onrender.com/forecast?days=${days}`);
